About cuequivariance-torch-feedstock
====================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/cuequivariance-torch-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/cuequivariance-torch-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add cuequivariance-torch
# for installing globally
pixi global install cuequivariance-torch
```
...
It is possible to list all of the versions of `cuequivariance-torch` available on your platform:
...
```
pixi search cuequivariance-torch --channel conda-forge
```
